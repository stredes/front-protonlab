...
export const blogCategories: BlogCategory[] = [
  {
    ...
    name: 'Automatización',
    slug: 'automatizacion',
    description: 'Integración, automatización y optimización de procesos para empresas.',
    icon: '⚙️',
  },
  {
    id: '2',
    ...
    description: 'Hardware, cómputo acelerado y plataformas para cargas intensivas.',
    icon: '🧠',
  },
  {
    id: '3',
    name: 'Robótica',
    slug: 'robotica',
    description: 'Aplicaciones robóticas, despliegue operativo y sistemas ciberfísicos.',
    icon: '🤖',
  },
  {
    id: '4',
    name: 'Operación Empresarial',
    slug: 'operacion-empresarial',
    description: 'Continuidad, soporte técnico y escalabilidad para entornos corporativos.',
    icon: '📈',
  },
];
